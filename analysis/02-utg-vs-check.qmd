...
There are several follow-up questions we should investigate:

- After inverting the z-axis, does this visualization become more informative?
- What is the correlation between Mahalanobis distance and \(1/\text{Check}\)?
- To what extent does this clustering approach group flops with very different checking frequencies into the same cluster?
## K = 5
